...
module.onClick = function()
	...
	game:GetService("ReplicatedStorage"):WaitForChild("Events"):WaitForChild("ConstructHiveCellFromEgg"):InvokeServer(getgenv().slotX, getgenv().slotY, "FestiveBeeJelly", 1, false)
	task.wait(0.3)
